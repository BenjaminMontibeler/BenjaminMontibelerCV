    ...
    <div className='App container-fluid'>
      ...
      <div className='about-me row' id='about'>
        ...
        <p data-aos="fade-right" data-aos-offset="200" data-aos-once="true">
          ...
          study of computer science at FERIT. Throughout the last few years of studying, I’ve come across many branches of programming, but user 
          interface design and front-end development stuck out the most. As I am about to finish school, I’ve decided to dedicate my career to 
          exactly that. I consider myself a very creative, ambitious, innovative and hard-working person, which is why I would consider myself 
          suited for such a job. I'm looking forward to participating in a dynamic work environment where I will gain teamwork experience that 
          will enable me to improve my analytical and problem-solving skills.
        </p>
      </div>
